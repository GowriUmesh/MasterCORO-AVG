...
def main(video_path: str = '../img/armen.mp4'):
    vo = VisualOdometry([684.169232, 680.105767, 365.163397, 292.358876])
    cap = cv2.VideoCapture('../img/armen.mp4')
    ...
    if video_path != '':
        ...
        out = cv2.VideoWriter('../Results/vo_result.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 10, (width, height))
    ...
    while cap.isOpened():
        ...
        incoming_M_c0 = vo.run(frame, update_src_frame=False)
